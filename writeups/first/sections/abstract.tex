...
tree-like state graphs of board games, \emph{adapting} these methods to acquire
state information from sampled human gameplay, and \emph{scaling} them to
combinatorial-size state spaces. The simple game of Tic-Tac-Toe is used as a
testbed, and the classic game of Go is used, at increasing board sizes, as a
long-term goal.
